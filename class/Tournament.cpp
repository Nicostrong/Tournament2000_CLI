...
Tournament::Tournament(cSet settings):	_settings(settings), _sixteenths(nullptr), _heighths(nullptr),
...
Tournament::Tournament(cSet settings, cvpPart participants): Tournament(settings)
{
